  ...
  <div id="tags-view-container" class="tags-view-container">
    <scroll-pane ref="scrollPane" class="tags-view-wrapper">
      <router-link v-for="tag in visitedViews" ref="tag" :key="tag.path" :class="isActive(tag) ? 'active' : ''"
        ...
        @click.middle.native="closeHandle(tag)" @contextmenu.prevent.native="openMenu(tag, $event)">
        {{ tag | formatTitle }}
        <span v-if="!tag.meta.noClose" class="el-icon-close" @click.prevent.stop="closeHandle(tag)" />
      </router-link>
    </scroll-pane>
