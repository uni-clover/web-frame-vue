...
.wscn-http404 .pic-404__child.left {
  ...
  left: 220px;
  opacity: 0;
  -webkit-animation-name: cloudLeft-data-v-5ad80bc6;
  animation-name: cloudLeft-data-v-5ad80bc6;
...
@-webkit-keyframes cloudLeft-data-v-5ad80bc6 {
  0% {
    top: 17px;
    left: 220px;
    opacity: 0;
...
@keyframes cloudLeft-data-v-5ad80bc6 {
  0% {
    top: 17px;
    left: 220px;
    opacity: 0;
